...
int getStartingCurrentSolution(vector<int> *tempPath, int dimension, vector<vector<int> > costs){
  ...
  cout << "PATH: "; printVector(*tempPath); cout << endl;
...
int main(int argc, const char * argv[]) {
  ...
  cout << "Costs:" << endl; printBidimensionalVector(costs);
  cout << endl << "Starting Current Solution:" << endl; printVector(tempPath);
  ...
  cout << "Best Solution:"; printVector(bestPath);
